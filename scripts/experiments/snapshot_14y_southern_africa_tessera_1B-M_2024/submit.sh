...
# 2024) on the 14-year (2010-2023) multi-region snapshot dataset.
#
# Sweep axes live at two levels:
#   - THIS FOLDER fixes the tessera variant (1B-M) and embedding year
#     (2024), exported below as TESSERA_VARIANT / EMBED_YEAR and
...
#
# Output dir: .tmp_output/training_runs_snapshot_14y_southern_africa_tessera_1B-M_2024/
#
# Usage (from repo root) — DRY RUN IS THE DEFAULT for this folder:
#   bash projects/tessera_downscaling/scripts/experiments/snapshot_14y_southern_africa_tessera_1B-M_2024/submit.sh
# Real submission:
#   DRY_RUN=0 bash projects/tessera_downscaling/scripts/experiments/snapshot_14y_southern_africa_tessera_1B-M_2024/submit.sh
set -euo pipefail
...
OUTPUT_ROOT="${BASE_DIR}/training_runs_snapshot_14y_southern_africa_tessera_1B-M_2024"
