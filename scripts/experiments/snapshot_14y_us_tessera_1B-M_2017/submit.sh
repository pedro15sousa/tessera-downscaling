#!/bin/bash
# Submit the us TESSERA-1B-M VAE-latent sweep (embedding year
...
#
# Output dir: .tmp_output/training_runs_snapshot_14y_us_tessera_1B-M_2017/
#
# Usage (from repo root) — DRY RUN IS THE DEFAULT for this folder:
#   bash projects/tessera_downscaling/scripts/experiments/snapshot_14y_us_tessera_1B-M_2017/submit.sh
# Real submission:
#   DRY_RUN=0 bash projects/tessera_downscaling/scripts/experiments/snapshot_14y_us_tessera_1B-M_2017/submit.sh
set -euo pipefail
...
OUTPUT_ROOT="${BASE_DIR}/training_runs_snapshot_14y_us_tessera_1B-M_2017"
