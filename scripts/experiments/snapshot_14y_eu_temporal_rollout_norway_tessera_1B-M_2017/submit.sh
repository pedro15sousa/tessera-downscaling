...
export VAE_LATENTS_PATH="${VAE_LATENTS_PATH:-${VAE_LATENTS_DIR}/station_latents_${TESSERA_VARIANT}_p128_${EMBED_YEAR}_crop64_lat16_grad0.5_auxon.npy}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${BASE_DIR}/training_runs_snapshot_14y_eu_temporal_rollout_norway_tessera_1B-M_2017}"
...
echo "============================================"
echo "Submitting snapshot_14y_eu_temporal_rollout_norway_tessera_1B-M_2017"
echo "============================================"
