...
# projects/tessera_downscaling/scripts/experiments/snapshot_14y_east_asia/experiments.yaml
...
#
# Output dir: .tmp_output/training_runs_snapshot_14y_east_asia/
#
...
#   bash projects/tessera_downscaling/scripts/experiments/snapshot_14y_east_asia/submit.sh
#
# Dry run (prints sbatch commands without submitting):
#   DRY_RUN=1 bash projects/tessera_downscaling/scripts/experiments/snapshot_14y_east_asia/submit.sh
set -euo pipefail
...
OUTPUT_ROOT="${BASE_DIR}/training_runs_snapshot_14y_east_asia"
