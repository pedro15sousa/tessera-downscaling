...
# projects/tessera_downscaling/scripts/experiments/snapshot_14y_us/experiments.yaml
...
#
# Output dir: .tmp_output/training_runs_snapshot_14y_us/
#
...
OUTPUT_ROOT="${BASE_DIR}/training_runs_snapshot_14y_us"
