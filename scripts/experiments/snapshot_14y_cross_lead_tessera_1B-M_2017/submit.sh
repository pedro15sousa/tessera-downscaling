...
# TESSERA arm ONLY, with the 1B-M (v2, 2017) candidate latents
# (crop64_lat16_auxon). Baselines + ERA5-interp rows are NOT re-run here —
# they are latents-independent and live in training_runs_snapshot_14y_cross_lead.
# =========================================================================
...
export VAE_LATENTS_PATH="${VAE_LATENTS_DIR}/station_latents_${TESSERA_VARIANT}_p128_${EMBED_YEAR}_crop64_lat16_grad0.5_auxon.npy"
export VAE_LATENTS_CSV="${BASE_DIR}/processed/tessera_global/station_list_filtered.csv"

OUTPUT_BASE="${BASE_DIR}/training_runs_snapshot_14y_cross_lead_tessera_1B-M_2017"
...
for REGION in "${REGIONS[@]}"; do
    ...
    for experiment in "${EXPERIMENTS[@]}"; do
        ...
        for seed in "${SEEDS[@]}"; do
            ...
            job_name="xl1BM17_${REGION}_${name}_s${seed}"
...
echo ""
echo "============================================"
echo "Submitted ${JOB_COUNT} sbatch jobs (snapshot_14y_cross_lead_tessera_1B-M_2017)"
echo "============================================"
echo ""
