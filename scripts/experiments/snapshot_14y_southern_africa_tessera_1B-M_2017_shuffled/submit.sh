...
#   DRY_RUN=1 bash scripts/experiments/snapshot_14y_southern_africa_tessera_1B-M_2017_shuffled/submit.sh    # print the commands only
#   LOCAL=1   bash scripts/experiments/snapshot_14y_southern_africa_tessera_1B-M_2017_shuffled/submit.sh    # run sequentially in this shell
