#!/usr/bin/env bash
# Submit the baseline arms for region "europe" of the paper: no-model references
...
# --train-regions europe (per-region normalisation stats); runs land in
# <data root>/training_runs_snapshot_14y_eu/<name>_seed<S>.
#
