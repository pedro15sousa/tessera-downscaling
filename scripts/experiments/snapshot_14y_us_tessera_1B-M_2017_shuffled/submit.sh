...
#
# Output dir: .tmp_output/training_runs_snapshot_14y_us_tessera_1B-M_2017_shuffled/
#
# Usage (from repo root) — DRY RUN IS THE DEFAULT for this folder:
#   bash projects/tessera_downscaling/scripts/experiments/snapshot_14y_us_tessera_1B-M_2017_shuffled/submit.sh
# Real submission:
#   DRY_RUN=0 bash projects/tessera_downscaling/scripts/experiments/snapshot_14y_us_tessera_1B-M_2017_shuffled/submit.sh
set -euo pipefail
...
OUTPUT_ROOT="${BASE_DIR}/training_runs_snapshot_14y_us_tessera_1B-M_2017_shuffled"
