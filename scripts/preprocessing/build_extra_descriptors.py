...
``projects/dataprocessing/scripts/gee/fetch_station_extra_descriptors.py`` and
...
Usage (from repo root):
    .venv/bin/python projects/tessera_downscaling/scripts/preprocessing/build_extra_descriptors.py \
        --descriptors-csv projects/tessera_downscaling/.tmp_output/processed/station_extra_descriptors.csv \
        --station-csv     projects/tessera_downscaling/.tmp_output/processed/tessera_global/station_list_filtered.csv \
        --output-npy      projects/tessera_downscaling/.tmp_output/processed/extra_descriptors.npy
"""
