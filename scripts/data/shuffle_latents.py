...
Usage (the paper's shuffled control, Table 4 / App. C):
    uv run python scripts/data/shuffle_latents.py \\
        --input  <data root>/processed/vae_tessera_1B-M/station_latents_1B-M_p128_2017_crop64_lat16_grad0.5_auxon.npy \\
...
def main() -> None:
    ...
    # filter_stations_by_vae_latents in data/helpers.py — it checks
