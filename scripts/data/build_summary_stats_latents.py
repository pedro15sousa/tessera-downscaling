...
Example (the paper's Appendix-A control, 16 stats over the central 64x64 window
of the 1B-M 2017 p128 patches, NaN-mask aligned to the crop64_lat16_auxon latents):
    uv run python scripts/data/build_summary_stats_latents.py \\
        ...
        --align-nan-mask-to ${DATA_ROOT}/processed/vae_tessera_1B-M/station_latents_1B-M_p128_2017_crop64_lat16_grad0.5_auxon.npy
"""
...
def main() -> None:
    ...
    logger.info("Reading station CSVs:")
