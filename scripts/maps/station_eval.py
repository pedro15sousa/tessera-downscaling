...
from generate_maps import (  # noqa: E402
    R, build_model, build_ctx, bilinear_grid_to_points, BASE, EU, RUNS, SEEDS, OUT_DIR,
)
from tessera_downscaling.data.dataset import MultiRegionSnapshotDownscalingDataset  # noqa: E402

VAE_LAT = BASE / "processed/station_latents_lat16_grad0.5.npy"
VAE_CSV = BASE / "processed/tessera_global/station_list_filtered.csv"
